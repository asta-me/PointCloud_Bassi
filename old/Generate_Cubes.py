# -*- coding: utf-8 -*-
"""
Created on Mon Nov 13 11:48:46 2023
...
Ovvero una serie di cubi dei quali posso impostare coordinate del centro , lunghezza lato, rotazione.

Restituisce 6 numpy array x1,y1,z1,x2,y2,z2, tali che l'n-esimo segmento abbia estremi x1[n],y1[n],z1[n] ed x2[n],y2[n],z2[n]
(in metri)
...
def compute_cube_edges(center, side_length, angles):
    ...
    for i in range(3):
        ...
        for j in range(len(cube_points)):
            cube_points[j] = rotate_around_axis(cube_points[j], axis, angles[i])
